    ...
    <div id="content">
       <!--left-->
         <div class="left" id="about_me">
           <div class="weizi">
           <div class="wz_text">当前位置：<a href="#">相册展示</a>><h1>上传照片</h1></div>
           </div>
           <div class="about_content">
           <form action="/boke/TP/index.php/Home/Index/photo_add" enctype="multipart/form-data" method="post" >
                 <p align="center"><input type="file" name="file"><input type="submit" value="上传"></p>
            </form>
           </div>
         </div>
         <!--end left -->
