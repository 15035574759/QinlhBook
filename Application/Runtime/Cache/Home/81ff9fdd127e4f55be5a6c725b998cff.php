           ...
           <div class="wz">
            <h3><a href="#" title="<?php echo ($v["bt"]); ?>"><?php echo ($v["bt"]); ?></a></h3>
             <dl>
               ...
               <span class="left fl">分类:<a href="/boke/admin/index.php/Home/Index/read?id=<?php echo ($v["id"]); ?>" title="学无止境"><?php echo ($v["s_name"]); ?></a></span><span class="left yd"><a href="/boke/admin/index.php/Home/Index/read?id=<?php echo ($v["id"]); ?>" title="阅读全文">阅读全文</a>
               </span>
                <div class="clear"></div>
               </p>
               </dd>
