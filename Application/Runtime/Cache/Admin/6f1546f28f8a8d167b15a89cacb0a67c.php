    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a href="<?php echo U('Limits/login_show');?>">管理员</a></li>
                <li><a href="<?php echo U('Login/pwd_save');?>">修改密码</a></li>
     ...
     <div class="sidebar-content">
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?php echo U('Limits/login_show');?>"><i class="icon-font">&#xe017;</i>管理员管理</a></li>
                        <li><a href="<?php echo U('Limits/role');?>"><i class="icon-font">&#xe037;</i>角色管理</a></li>
                        <li><a href="<?php echo U('Limits/node');?>"><i class="icon-font">&#xe046;</i>节点管理</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/boke/TP/index.php/Admin/Limits/node_add_pro" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?php echo ($arr["title"]); ?>" type="text" placeholder="请输入名称">
                                </td>
                                <tr>
                                <th><i class="require-red">*</i>控制器：</th>
                                <td>
                                    <input class="common-text required" id="title" name="controller" size="50" value="<?php echo ($arr["controller"]); ?>" type="text" placeholder="简短描述">
                                </td>
                                </tr>
                            </tr>
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="action" size="50" value="<?php echo ($arr["action"]); ?>" type="text" placeholder="请输入名称">
                                </td>
                            </tr>
                       <!-- <tr>
