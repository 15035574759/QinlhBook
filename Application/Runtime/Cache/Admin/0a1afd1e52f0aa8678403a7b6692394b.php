...
<div id="wrapper">
  ...
  <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
        <div class="panel-heading">
          <h2 style="float:left;">节点列表</h2> <b style="float:right;font-size:18px;"> <a href="/boke/admin/index.php/Admin/Limits/node_add" style="color:#FF5454;">添加节点</a></b>
          ...
          <table class="table table-striped">
            <tbody>
              ...
              <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                  ...
                  <a class="link-del" href="/boke/admin/index.php/Admin/Limits/node_del?id=<?php echo ($v["node_id"]); ?>">删除</a>
                  </td>
