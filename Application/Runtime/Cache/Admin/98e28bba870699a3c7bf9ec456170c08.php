...
<div id="wrapper">
     <!-- Navigation -->
       ...
       <div class="xs">
        ...
        <form action="/boke/admin/index.php/Admin/Article/articleUpdate" method="post" enctype="multipart/form-data">
        <input type="hidden" name="art_id" value="<?php echo ($art_id); ?>">
          <fieldset>
            <div class="form-group">
              <label class="control-label">标题：</label>
              <input type="text" name="bt" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" value="<?php echo ($content["bt"]); ?>" style="width:500px;" required="">
            </div>
            <div class="form-group">
              <label class="control-label">分类：</label>
                  
                <select id="selector1" class="form-control1" name="search_sort" style="width:43%;">
                      <option>==请选择==</option>
                    <?php if(is_array($class)): foreach($class as $key=>$v): ?><option value="<?php echo ($v["s_id"]); ?>" id="getChd"><?php echo ($v["s_name"]); ?></option><?php endforeach; endif; ?>
                </select>
                 
            </div>
            <div class="form-group">
              <label class="control-label">描述：</label>
              <input type="text" name="ms" class="form-control1 ng-invalid ng-invalid-required ng-touched" ng-model="model.password" value="<?php echo ($content["ms"]); ?>" style="width:500px;" required="">
            </div>
            <div class="form-group">
              <label class="control-label">作者：</label>
              <input type="text" name="name" class="form-control1 ng-invalid ng-valid-url ng-invalid-required ng-touched" ng-model="model.url" value="<?php echo ($content["name"]); ?>" style="width:500px;" required="">
            </div>
            <div class="form-group">
              <label class="control-label">图片：</label>
              <!-- <input name="photo"  id="" type="file" style="width:500px;"> -->
               <input type="file" name="photo" style="margin-left:100px;" value="<?php echo ($content["photo"]); ?>">
            </div>
            <div class="form-group">
              <label class="control-label normal">内容：</label>
             <textarea name="nr" class="common-textarea" id="content" cols="30" style="width: 98%;height:500px;" rows="10" placeholder="请输入发表文章内容"><?php echo ($content["nr"]); ?></textarea>
            </div>
