...
<div id="wrapper">
     <!-- Navigation -->
                       ...
                       <!--  <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo U('Limits/role');?>">角色管理</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Limits/node');?>">节点管理</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level
                        <!-- </li> -->
       ...
       <div class="xs">
        ...
        <form action="/boke/admin/index.php/Admin/Photo/photo_add_pro" method="post" enctype="multipart/form-data">
          <fieldset>
            <div class="form-group">
              <label class="control-label">描述一下：</label>
              <input type="text" name="ms" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" style="width:500px;" required="" placeholder="请输入描述">
            </div>
            <div class="form-group">
