    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/boke/TP/index.php/Admin/Index/diary_fabu" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="time" size="50" value="" type="text" placeholder="请输入时间">
                                </td>
                                <tr>
      ...
      <!--                       <tr>
                            ...
                            <tr>
                                ...
                                <td><textarea name="rj" class="common-textarea" id="content" cols="30" style="width: 98%;height:500px;" rows="10" placeholder="请输入今天的心情"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td class="fabu">
