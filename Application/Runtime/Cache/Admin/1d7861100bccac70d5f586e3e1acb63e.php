          ...
          <table class="table table-striped">
            <tbody>
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                    <td ><?php echo ($v["id"]); ?></td>
                    <td><a href="/boke/admin/index.php/Admin/Diary/diary_show?id=<?php echo ($v["id"]); ?>" title="<?php echo ($v["bt"]); ?>"><?php echo ($v["title"]); ?></a></td>
                     <td height="50px"><a href="/boke/admin/index.php/Admin/Diary/diary_show?id=<?php echo ($v["id"]); ?>"><img src="/boke/admin/<?php echo ($v["photo"]); ?>" alt="" width="100"></a></td>
                    <td ><?php echo ($v["time"]); ?>… </td>
                    <td>
                        <a class="link-del" href="/boke/admin/index.php/Admin/Diary/diary_save?diary_id=<?php echo ($v["id"]); ?>">修改</a>
                        <a class="link-del" href="/boke/admin/index.php/Admin/Diary/diary_del?id=<?php echo ($v["id"]); ?>">删除</a>
                    </td>
