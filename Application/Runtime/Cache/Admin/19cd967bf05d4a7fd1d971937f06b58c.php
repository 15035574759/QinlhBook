    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/boke/TP/index.php/Admin/Index/sort_add_pro" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%" height="300">
                        <tbody><tr>
                        </tr>
                            <tr>
                                <th><i class="require-red">*</i>分类：</th>
                                <td>
                                    <input class="common-text required" id="title" name="s_name" size="50" value="" type="text" placeholder="请输入添加分类">
                                </td>
