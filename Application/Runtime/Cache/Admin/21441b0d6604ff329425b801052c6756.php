...
<div id="wrapper">
  ...
  <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
        <div class="panel-heading">
         ...
         <div style="border:1px #f00 solid;width:600px;height:600px;margin-left:300px;">
                  
                   <p style="font-size:18px;text-align:center;"><?php echo ($bt); ?></p><br>
                      <?php if(is_array($res)): foreach($res as $key=>$v): ?><p style="text-indent:4em;"><?php echo ($v["name"]); ?>:&nbsp;&nbsp;<?php echo ($v["nr"]); ?>:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["time"]); ?></p><br><?php endforeach; endif; ?>
                        
               </div> 
              <tr>
              <td>
                  <input class="btn btn6" style="margin-left:550px;background:green;margin-top:20px;" onclick="history.go(-1)" value="返回" type="button">
              </td>
              </tr>
    <!--/main-->
</div>
