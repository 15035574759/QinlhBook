...
<div id="wrapper">
  ...
  <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
        <div class="panel-heading">
          <h2 style="float:left;">角色列表</h2> <b style="float:right;font-size:18px;"> <a href="/boke/admin/index.php/Admin/Limits/role_add" style="color:#FF5454;">添加角色</a></b>
          ...
          <table class="table table-striped">
            <tbody>
              ...
              <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                  ...
                  <td>
                      <a class="link-del" href="/boke/admin/index.php/Admin/Limits/role_save?id=<?php echo ($v["role_id"]); ?>">修改</a>
                      <a class="link-del" href="/boke/admin/index.php/Admin/Limits/role_del?id=<?php echo ($v["role_id"]); ?>">删除</a>
                  </td>
