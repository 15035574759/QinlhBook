...
<div id="wrapper">
     <!-- Navigation -->
       ...
       <div class="xs">
        ...
        <form action="/boke/admin/index.php/Admin/Limits/login_save_pro" method="post" enctype="multipart/form-data">
          <fieldset>
            <div class="form-group">
              <label class="control-label">管理员姓名：</label>
              <input type="text" name="bt" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" value="<?php echo ($arr["username"]); ?>" value="<?php echo ($arr["username"]); ?>" style="width:500px;" required="">
            </div>
            <div class="form-group">
