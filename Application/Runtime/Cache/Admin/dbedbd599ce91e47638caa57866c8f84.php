...
<div id="wrapper">
  ...
  <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
        <div class="panel-heading">
          <h2 style="float:left;">管理员列表</h2> <b style="float:right;font-size:18px;"> <a href="/boke/admin/index.php/Admin/Limits/login_add" style="color:#FF5454;">添加管理员</a></b>
          ...
          <table class="table table-striped">
            <tbody>
              ...
              <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                  ...
                  <td>******</td>
                  <td>
                      <a class="link-del" href="/boke/admin/index.php/Admin/Limits/login_save?id=<?php echo ($v["id"]); ?>">修改</a>
                      <a class="link-del" href="/boke/admin/index.php/Admin/Limits/login_del?id=<?php echo ($v["id"]); ?>">删除</a>
                  </td>
