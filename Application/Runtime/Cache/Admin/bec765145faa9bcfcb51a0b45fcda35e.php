...
<div id="wrapper">
     <!-- Navigation -->
       ...
       <div class="xs">
        ...
        <form action="/boke/admin/index.php/Admin/Login/password_save" method="post" enctype="multipart/form-data">
          <fieldset>
            <div class="form-group">
              <label class="control-label">管理员姓名：</label>
              <input type="text" name="username" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" value="<?php echo ($arr["username"]); ?>" value="<?php echo ($arr["username"]); ?>" style="width:500px;" required="">
            </div>
            <div class="form-group">
              <label class="control-label">密码：</label>
              <input type="password" name="bt" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" value="******" style="width:500px;" required="">
            </div>
            <div class="form-group">
              <label class="control-label">管理员性别：</label>
              <input type="text" name="sex" class="form-control1 ng-invalid ng-invalid-required ng-touched" ng-model="model.password" value="<?php echo ($arr["sex"]); ?>" style="width:500px;" required="">
            </div>
            <div class="form-group">
              <label class="control-label">管理员年龄：</label>
              <input type="text" name="age" class="form-control1 ng-invalid ng-valid-url ng-invalid-required ng-touched" ng-model="model.url" value="<?php echo ($arr["age"]); ?>" style="width:500px;" required="">
            </div>
            </div>
            <br><br>
