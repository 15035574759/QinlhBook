...
<div id="wrapper">
     <!-- Navigation -->
       ...
       <div class="xs">
        ...
        <form action="/boke/admin/index.php/Admin/Sort/sort_add_pro" method="post" enctype="multipart/form-data">
          <fieldset>
            <div class="form-group">
              <label class="control-label">分类名称</label>
               <input class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" id="title" name="s_name" size="50" value="" type="text" placeholder="请输入添加分类" style="width:500px;">
            </div>
            <br>
