            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/boke/TP/index.php/Admin/Index/diary_add"><i class="icon-font"></i>新增日记</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                            ...
                            <th width="300px" >背景</th>
                            <th width="100">操作</th>
                        </tr>
                        <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                            <td style="font-size:25px;"><?php echo ($v["id"]); ?></td>
                            <td><a href="/boke/TP/index.php/Admin/Index/diary_show?id=<?php echo ($v["id"]); ?>" title="<?php echo ($v["bt"]); ?>" style="font-size:25px;"><?php echo ($v["time"]); ?>…</a> </td>
                             <td height="50px"><a href="/boke/TP/index.php/Admin/Index/diary_show?id=<?php echo ($v["id"]); ?>"><img src="/boke/TP/<?php echo ($v["photo"]); ?>" alt="" width="200"></a></td>
                            <td>
                                <a class="link-del" href="/boke/TP/index.php/Admin/Index/diary_del?id=<?php echo ($v["id"]); ?>" style="font-size:25px;">删除</a>
                            </td>
