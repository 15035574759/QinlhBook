            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="design.html"><i class="icon-font">&#xe005;</i>日记管理</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/boke/TP/index.php/Admin/Index/" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="s_id" id="catid" class="required">
                                    ...
                                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><option value="<?php echo ($v["s_name"]); ?>"><?php echo ($v["s_name"]); ?></option><?php endforeach; endif; ?>
                                </select>
                            </td>
                        </tr>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="bt" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>作者：</th>
      ...
      <!--                       <tr>
                            ...
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="nr" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
