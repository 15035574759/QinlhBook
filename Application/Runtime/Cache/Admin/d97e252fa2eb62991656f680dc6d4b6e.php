                ...
                <li class="dropdown">
                    ...
                    <?php if(is_array($topLeaveData)): foreach($topLeaveData as $key=>$v): ?><li class="avatar">
                        ...
                        <li class="dropdown-menu-footer text-center">
                            <a href="<?php echo U('Leave/leave');?>">View all messages</a>
                        </li> 
                    </ul>
                </li>
                <li class="dropdown">
        ...
        <div class="well1 white">
          <fieldset>
            <div class="form-group">
              ...
              <input type="text" name="bt"  readonly="readonly" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" value="<?php echo ($res["name"]); ?>" style="width:500px;" required="">
            </div>
            <div class="form-group">
              <label class="control-label">留言时间：</label>
              <input type="text" name="ms"  readonly="readonly" class="form-control1 ng-invalid ng-invalid-required ng-touched" ng-model="model.password" value="<?php echo ($res["time"]); ?>" style="width:500px;" required="">
            </div>
            <div class="form-group">
              <label class="control-label normal">留言内容：</label>
            <?php echo ($res["nr"]); ?>
            </div>
             <div class="form-group" style="margin-left:300px;">
              <!-- <button type="submit" class="btn btn-primary">回复</button> -->
              <button class="btn btn-primary" onclick="checkhf(id=<?php echo ($res["id"]); ?>)">回复</button>
...
<script>
    function checkhf(id){
        location="/boke/admin/index.php/Admin/Leave/leave_hf?id="+id;
    }
</script>
</html>