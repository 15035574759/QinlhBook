...
<div id="wrapper">
     <!-- Navigation -->
       ...
       <div class="xs">
        ...
        <form action="/boke/admin/index.php/Admin/Limits/role_save_pro" method="post" id="myform" name="myform" enctype="multipart/form-data">
         <input type="hidden" value="<?php echo ($arr["role_id"]); ?>" name="id">
                    <table class="insert-tab" width="100%" height="400">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="role_name" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" value="<?php echo ($arr["role_name"]); ?>" style="width:500px;" required="" placeholder="角色名称">
                                </td>
                             </tr>
                            <tr>
                                <th><br><br><label class="control-label">简短描述：</label></th>
                                <td>
                                    <input type="text" name="role_desc" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" value="<?php echo ($arr["role_desc"]); ?>" style="width:500px;" required="" placeholder="简短描述">
                                </td>
                            </tr>
      ...
      <!--                       <tr>
                        ...
                        <?php if(is_array($node_parent)): foreach($node_parent as $key=>$val): ?><tr>
                              <td></td>
                                <td>   
                                     <input  type="checkbox" <?php if($val["p"] == 1): ?>checked<?php endif; ?> name="node_id[]" value="<?php echo ($val["node_id"]); ?>">&nbsp;<font color="green"><?php echo ($val["title"]); ?></font>&nbsp;&nbsp;<br>
                              
                                    <?php if(is_array($val["son"])): foreach($val["son"] as $key=>$v): ?>&nbsp;&nbsp;&nbsp;&nbsp;<input  type="checkbox" <?php if($v["p"] == 1): ?>checked<?php endif; ?> name="node_id[]" value="<?php echo ($v["node_id"]); ?>">&nbsp;<?php echo ($v["title"]); ?>&nbsp;&nbsp;<?php endforeach; endif; ?>
                                </td>
