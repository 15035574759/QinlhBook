          ...
          <table class="table table-striped">
            <tbody>
              <tr>
                  <th width="100">ID</th>
                  <th width="200">图片</th>
                  <th width="200px" >简单描述</th>
                  <th width="100">更新时间</th>
                  <th width="100">操作</th>
              </tr>
              <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                  <td style="font-size:25px;"><?php echo ($v["id"]); ?></td>
                  <td><a href="/boke/admin/<?php echo ($v["photo"]); ?>"  style="font-size:25px;"><img src="/boke/admin/<?php echo ($v["photo"]); ?>" alt="" width="200"></a> </td>
                   <td height="50px"><?php echo ($v["ms"]); ?></td>
                   <td height="50px"><?php echo ($v["time"]); ?></td>
                  <td>
                      <a class="link-del" href="/boke/admin/index.php/Admin/Photo/photo_del?id=<?php echo ($v["id"]); ?>" style="font-size:25px;">删除</a>
                  </td>
