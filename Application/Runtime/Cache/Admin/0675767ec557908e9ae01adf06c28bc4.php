...
<div id="wrapper">
     <!-- Navigation -->
       ...
       <div class="xs">
        ...
        <form action="/boke/admin/index.php/Admin/Diary/diary_fabu" method="post" enctype="multipart/form-data">
          <fieldset>
            <div class="form-group">
              <label class="control-label">时间</label>
              <input type="text" name="bt" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" style="width:500px;" required="" placeholder="请填写日期">
            </div>
            <div class="form-group">
              <label class="control-label">题目</label>
              <input type="text" name="title" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" style="width:500px;" required="" placeholder="写一个标题吧">
            </div>
            <div class="form-group">
            ...
            <textarea name="rj" class="common-textarea" id="content" cols="30" style="width: 98%;height:500px;" rows="10" placeholder="请输入今天的心情"></textarea>
            </div>
