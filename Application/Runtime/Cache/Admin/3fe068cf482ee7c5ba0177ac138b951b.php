...
<div id="wrapper">
     <!-- Navigation -->
       ...
       <div class="xs">
        ...
        <form action="/boke/admin/index.php/Admin/Diary/article_add" method="post" enctype="multipart/form-data">
          <fieldset>
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea name="nr" class="common-textarea" id="content" cols="30" style="width: 98%;height:500px;" rows="10" placeholder="请输入发表文章内容"><?php echo ($res["rj"]); ?></textarea>
            </div>
          </fieldset>
        </form>
      </div>
