...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">权限管理</a><span class="crumb-step">&gt;</span><span>新增角色</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/boke/TP/index.php/Admin/Login/role_add_pro" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="role_name" size="50" value="" type="text" placeholder="请输入名称">
                                </td>
                                <tr>
                                <th><i class="require-red">*</i>简短描述：</th>
                                <td>
                                    <input class="common-text required" id="title" name="role_desc" size="50" value="" type="text" placeholder="简短描述">
                                </td>
                                </tr>
                            </tr>
      <!--                       <tr>
                             ...
                             <tr>
                                <th><i class="require-red">*</i>节点分配：</th>
                                <td>
                                    <?php if(is_array($res)): foreach($res as $key=>$v): ?><input type="checkbox" name="node_id[]" value="<?php echo ($v["node_id"]); ?>"><?php echo ($v["title"]); ?>&nbsp;&nbsp;<?php endforeach; endif; ?>
                                </td>
                            </tr>
                                <th></th>
                                <td class="fabu">
