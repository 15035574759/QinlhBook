     ...
     <!-- Navigation -->
       ...
       <div class="xs">
        ...
        <div class="well1 white">
         <form action="/boke/admin/index.php/Admin/Leave/leave_hf_pro" method="post" enctype="multipart/form-data">
          <fieldset>
            <div class="form-group">
              <label class="control-label">留言人：</label>
              <input type="text" name="name" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" value="<?php echo ($name); ?>" style="width:500px;" required="">
            </div>
            <div class="form-group">
              <label class="control-label normal">留言内容：</label>
            <textarea name="nr" class="common-textarea" id="" cols="30" style="width: 98%;height:300px;" rows="10" placeholder="请输入留言内容"></textarea>
            </div>
