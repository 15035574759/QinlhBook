            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="<?php echo U("Photo/photo");?>"><i class="icon-font">&#xe012;</i>照片管理</a></li>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/boke/TP/index.php/Admin/Index/sort_add"><i class="icon-font"></i>新增分类</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                            ...
                            <td>
                                <a class="link-del" href="/boke/TP/index.php/Admin/Index/sort_del?id=<?php echo ($v["s_id"]); ?>">删除</a>
                            </td>
