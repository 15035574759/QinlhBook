            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/boke/TP/index.php/Admin/Login/role_add"><i class="icon-font"></i>新增角色</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                            ...
                            <td>
                                <a class="link-del" href="/boke/TP/index.php/Admin/Login/role_del?id=<?php echo ($v["role_id"]); ?>">删除</a>
                            </td>
