    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content" style="margin-left:100px;">
                <form action="/boke/TP/index.php/Admin/Login/login_add_pro" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table style="height:500px;" class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="username" size="50" value="" type="text" placeholder="请输入管理员姓名">
                                </td>
                               </tr> 
                               <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="sex" size="50" value="" type="text" placeholder="请输入管理员姓名">
                                </td>
                                </tr> 
                                <tr>
                                <th><i class="require-red">*</i>管理员年龄：</th>
                                <td>
                                    <input class="common-text required" id="title" name="age" size="50" value="" type="text" placeholder="请输入管理员姓名">
                                </td>
                                </tr>
                            </tr>
      <!--                       <tr>
                            ...
                            <tr>
                                <th></th>
                                <td class="fabu" >
                                    <input style="margin-left:20px;" class="btn btn-primary btn6 mr10" value="添加" type="submit">
