	...
	$.fn.zySearch = function(options,param){
		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				var html = '';
				// html += '<form action="index" method="post" id="myform" name="myform" enctype="multipart/form-data">';
				html += '<b class="search-img"></b>'; 
				html += '<input id="searchInput" class="search-input" name="search" value="" type="text" placeholder="请输入关键字？">';
				// html += '<button class="search-btn btn">搜索</button>';
				html += '<input type="submit" value="搜索" class="search-btn btn"/>';
				// html += '</form>';
				$(self).append(html);
